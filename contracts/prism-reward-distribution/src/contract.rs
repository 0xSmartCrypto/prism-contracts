...
use cosmwasm_std::{
    ...
    MessageInfo, QuerierWrapper, Response, StdError, StdResult, WasmMsg,
};
...
pub fn instantiate(
    ...
    CONFIG.save(
        ...
        &Config {
            ...
            delegator_reward_denom: msg.delegator_reward_denom,
...
pub fn process_delegator_rewards(
    ...
    let delegator_reward_denom = cfg.delegator_reward_denom;

    let denoms: Vec<String> = balances.iter().map(|item| item.denom.clone()).collect();

    let exchange_rates = query_exchange_rates(&deps, delegator_reward_denom.clone(), denoms)?;
    ...
    for coin in balances {
        ...
        messages.push(create_swap_msg(coin, delegator_reward_denom.to_string()));
    }
...
pub fn distribute_rewards(
    ...
    for asset_info in asset_infos {
        ...
        let balance = match asset_info.clone() {
...
pub fn query_config(deps: Deps) -> StdResult<ConfigResponse> {
    ...
    Ok(ConfigResponse {
        ...
        delegator_reward_denom: cfg.delegator_reward_denom,
...
pub fn get_deposit_rewards_msgs(
    ...
    match asset.info.clone() {
        AssetInfo::NativeToken { denom } => Ok(vec![CosmosMsg::Wasm(WasmMsg::Execute {
        ...
        AssetInfo::Token { contract_addr } => Ok(vec![
